...
- Wordpress Instance through AWS
- Github
...
8. Click WordPress icon in the left to access overall dashboard 
...
#### Directions on how to access and download MySQL database by using plugins
1. Return to dashboard.
2. Click on plug-ins on the left side.
3. Click “Add New Plug-in”
4. Type in search box “WP-phpMyAdmin plugin”
5. Click Activate Plug-in

###### Directions to run the MySQL (wp-phpMyAdmin) database in our web application and to view our database.
...
4. From here, you should see the teams databases as well as the tables that were created.
